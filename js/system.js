...
document.addEventListener("DOMContentLoaded", function() {
    ...
    header.innerHTML = `
        <div style="font-size:0.7rem; letter-spacing:2px; font-family:var(--main-font); font-weight:bold;">VANGUARD_OS // ONLINE</div>
        <a href="${homePath}" style="color:var(--bright-teal); text-decoration:none; font-size:0.75rem; font-weight:bold; border:1px solid var(--bright-teal); padding:6px 15px; border-radius:5px;">MENU</a>
    `;
    document.body.appendChild(header);

    // 2. INJECT BOTTOM FOOTER
    ...
    footer.innerHTML = `<div style="font-size:0.7rem; color:rgba(255,255,255,0.5); letter-spacing:1px; text-transform:uppercase;">Built by Commander Q &copy; ${year}</div>`;
